package com.maurofokker.um.client.security;
...
import com.maurofokker.test.common.client.security.TokenResponse;
...
public class OAuthAuthenticator implements ITestAuthenticator {
    ...
    @Override
    public RequestSpecification givenAuthenticated(final String username, final String password) {
    ...
    final private String getAccessToken(final String username, final String password) {
        try {
